...
# FLIGHTCORE_4_4_0_RC14_SELF_CONTAINED_PUBLIC_BOOTSTRAP_V1
...
if [[ "$PLATFORM" == "Darwin" ]]; then
  ...
  LOG="$HOME/Downloads/FLIGHTCORE_4.4.0_RC14_FRESH_INSTALL_${TS}.txt"
  exec > >(tee "$LOG") 2>&1

  echo "FlightCore 4.4.0 RC14 - fresh installation launcher"
  ...
  echo "Verified published 4.4.0 RC14 installer SHA-256."

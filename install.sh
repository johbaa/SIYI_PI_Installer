#!/usr/bin/env bash
set -Eeuo pipefail
# FLIGHTCORE_4_2_3_RC7_GITHUB_HEAD_PIN_V1
...
req=urllib.request.Request(url,headers={'User-Agent':'FlightCore-Installer/4.2.3-RC7','Accept':'application/vnd.github+json','Cache-Control':'no-cache, no-store, max-age=0','Pragma':'no-cache'})

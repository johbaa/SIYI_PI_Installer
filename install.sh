...
# FLIGHTCORE_4_4_0_RC21_SELF_CONTAINED_PUBLIC_BOOTSTRAP_V1
...
if [[ "$PLATFORM" == "Darwin" ]]; then
  ...
  LOG="$HOME/Downloads/FLIGHTCORE_4.4.0_RC21_FRESH_INSTALL_${TS}.txt"
  exec > >(tee "$LOG") 2>&1

  echo "FlightCore 4.4.0 RC21 - fresh installation launcher"
  ...
  echo "Verified published 4.4.0 RC21 installer SHA-256."

...
# FLIGHTCORE_4_3_0_RC40_SELF_CONTAINED_PUBLIC_BOOTSTRAP_V1
...
if [[ "$(uname -s)" == "Darwin" ]]; then
  ...
  LOG="$HOME/Downloads/FLIGHTCORE_4.3.0_RC40_FRESH_INSTALL_${TS}.txt"
  exec > >(tee "$LOG") 2>&1

  echo "FlightCore 4.3.0 RC40 - fresh installation launcher"
  ...
  echo "Verified published RC40 installer SHA-256."

...
# FLIGHTCORE_4_3_0_RC18_PUBLIC_INSTALLER_IMMUTABLE_REUSE_V1
...
if [[ "$(uname -s)" == "Darwin" ]]; then
  ...
  LOG="$HOME/Downloads/FLIGHTCORE_4.3.0_RC18_FRESH_INSTALL_${TS}.txt"
  exec > >(tee "$LOG") 2>&1

  echo "FlightCore 4.3.0 RC18 - fresh installation launcher"
  ...
  echo "Verified published RC18 installer SHA-256."

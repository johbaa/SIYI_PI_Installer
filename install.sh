...
# FLIGHTCORE_4_3_0_RC31_RESUMABLE_PUBLIC_DOWNLOAD_V2
...
if [[ "$(uname -s)" == "Darwin" ]]; then
  ...
  LOG="$HOME/Downloads/FLIGHTCORE_4.3.0_RC31_FRESH_INSTALL_${TS}.txt"
  exec > >(tee "$LOG") 2>&1

  echo "FlightCore 4.3.0 RC31 - fresh installation launcher"
  ...
  echo "Verified published RC31 installer SHA-256."

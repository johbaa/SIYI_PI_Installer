...
# FLIGHTCORE_4_3_0_RC17_PUBLIC_INSTALLER_IMMUTABLE_REUSE_V1
...
if [[ "$(uname -s)" == "Darwin" ]]; then
  ...
  LOG="$HOME/Downloads/FLIGHTCORE_4.3.0_RC17_FRESH_INSTALL_${TS}.txt"
  exec > >(tee "$LOG") 2>&1

  echo "FlightCore 4.3.0 RC17 - fresh installation launcher"
  ...
  echo "Verified published RC17 installer SHA-256."

...
# FLIGHTCORE_4_4_0_RC7_SELF_CONTAINED_PUBLIC_BOOTSTRAP_V1
...
if [[ "$(uname -s)" == "Darwin" ]]; then
  ...
  LOG="$HOME/Downloads/FLIGHTCORE_4.4.0_RC7_FRESH_INSTALL_${TS}.txt"
  exec > >(tee "$LOG") 2>&1

  echo "FlightCore 4.4.0 RC7 - fresh installation launcher"
  ...
  echo "Verified published 4.4.0 RC7 installer SHA-256."

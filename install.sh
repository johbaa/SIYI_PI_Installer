...
# FLIGHTCORE_4_3_0_RC22_RESUMABLE_PUBLIC_DOWNLOAD_V2
...
if [[ "$(uname -s)" == "Darwin" ]]; then
  ...
  LOG="$HOME/Downloads/FLIGHTCORE_4.3.0_RC22_FRESH_INSTALL_${TS}.txt"
  exec > >(tee "$LOG") 2>&1

  echo "FlightCore 4.3.0 RC22 - fresh installation launcher"
  ...
  echo "Verified published RC22 installer SHA-256."
